...
<p style="line-height:120%"><h3> Nonparametric comparison of epidemic time trends: the case of COVID-19<br/>
<em>(with Michael Vogt, submitted to Journal of Econometrics)</em></h3></p>
...
<p style="line-height:120%"><h3> Multiscale Inference and Long-Run Variance Estimation in Nonparametric Regression with Time Series Errors<br/>
...
<p style="line-height:120%"><h3> Multiscale Testing for Equality of Nonparametric Trend Curves<br/>
<em>(with Michael Vogt, working paper)</em></h3></p>
